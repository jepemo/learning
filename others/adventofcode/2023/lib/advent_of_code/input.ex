defmodule AdventOfCode.Input do
  ...
  def get!(day, year) do
    cond do
      in_cache?(day, year) |> IO.inspect(label: "in_cache?(day, year)") ->
        from_cache!(day, year)
  ...
  defp from_cache!(day, year), do: cache_path(day, year) |> IO.inspect() |> File.read!()
  ...
  def read_from_file(day) do
    filepath = "#{File.cwd!()}/inputs/day#{day}.txt"
